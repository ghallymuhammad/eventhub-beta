  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email && password) {
        ...
        const mockUserData = {
          email,
          role: role.toUpperCase(), // Convert to match enum
          name: role === 'organizer' ? 'Music Events Indonesia' : 
                role === 'admin' ? 'System Administrator' : 'Ahmad Rahman',
          id: '1'
        };
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6">
          ...
          >
            {isLoading ? 'Signing in...' : `Sign in as ${role === 'organizer' ? 'Organizer' : 'Attendee'}`}
          </button>
        </div>
      </form>
